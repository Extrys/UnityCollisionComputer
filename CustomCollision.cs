...
public struct CustomCollision
{
	...
	[ShowInInspector] ContactPair m_Pair;
	...
	[ShowInInspector] public readonly Rigidbody dthisRigidbody => dthisBody as Rigidbody;
	[ShowInInspector] public readonly Rigidbody rigidbody => body as Rigidbody;
	...
	[ShowInInspector] public readonly Collider thisCollider => m_Flipped ? m_Pair.Collider : m_Pair.OtherCollider;
	[ShowInInspector] public readonly Collider collider => m_Flipped ? m_Pair.OtherCollider : m_Pair.Collider;
	...
	[ShowInInspector] public readonly int dcontactCount => m_Pair.ContactCount;
	[ShowInInspector] public readonly int dThisBodyInstanceId => m_Flipped ? m_Header.BodyInstanceID : m_Header.OtherBodyInstanceID;
	[ShowInInspector] public readonly int dOtherBodyInstanceId => m_Flipped ? m_Header.OtherBodyInstanceID : m_Header.BodyInstanceID;
